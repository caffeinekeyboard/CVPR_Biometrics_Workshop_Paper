...
class GumNetFeatureExtractionAP(nn.Module):
    ...
    Architectural Flow & Tensor Dimensions:
        ...
        - Block 1:
            - Conv2d:         (B, 32, 190, 190)
            - AvgPool2d:      (B, 32, 95, 95)
        - Block 2:
            - Conv2d:         (B, 64, 93, 93)
        - Block 3:
            - Conv2d:         (B, 128, 91, 91)
            - AvgPool2d:      (B, 128, 45, 45)
        - Block 4:
            - Conv2d:         (B, 256, 43, 43)
            - AvgPool2d:      (B, 256, 21, 21)
        - Block 5:
            - Conv2d:         (B, 512, 19, 19)
            - AdaptiveAvgPool:(B, 512, 14, 14)   | Reduces spatial dimensions gracefully
    ...
    def __init__(self, in_channels=1):
        ...
        # --- NEW: Adaptive Pooling to enforce exact output dimensions ---
